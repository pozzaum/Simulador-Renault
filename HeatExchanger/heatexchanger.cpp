...
void HeatExchanger::getDataFromFiles(){
...
void HeatExchanger::simulate(double argAirMassFlowRate,
    ...
    // 1 inicializando as variáveis de interesse
    ...
    double waterVaporPressure = argAirInletRelativeHumidity * CoolProp::PropsSI("P", "T", argAirInletTemperature, "Q", 1, "Water");
    double dewPoint = CoolProp::PropsSI("T", "P", waterVaporPressure, "Q", 1, "Water");
...
void HeatExchanger::getDataFromUI(){
