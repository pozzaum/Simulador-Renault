...
#    endif
#    include "../externals/fmtlib/include/fmt/format.h"  // For addition of the string formatting functions and macros from fmtlib
#    include "../externals/fmtlib/include/fmt/printf.h"  // For sprintf
